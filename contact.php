    ...
    <section class="hero-image" id="top">
      <div class="max-width">
        <div class="hero-text">
            ...
            <a href="#" class="btn btn-danger m-3 btn-mds">See Our Collection</a>
        </div>
      </div>
    </section> -->
...
<form id="contact-form" method="post" action="message.php" role="form">
  <h1 class="text-center mt-5 mb-4" style="font-size: 36px; color: #333;"><i class="fas fa-gem"></i> Contact Us</h1>
  <div class="form-outline text-center w-50 m-auto px-3 mt-2">
  ...
  <div class="form-outline w-50 m-auto px-3 mt-2">
    <button type="submit" class="btn btn-primary mb-5 px-3 mt-2" style="background-color: #333;">Send</button>
  </div>
</form>
