...
<body>
    ...
    <nav class="navbar sticky-top navbar-light navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <li class="nav-item"><a href="profile.php" class="nav-link active text-black ">My Account</a></li>  
            ...
            <li class="nav-item"><a href="#" class="nav-link active text-black ">$<?php total_cart_price(); ?></a></li></ul>
    ...
    <div class="row">
        <div class="col-md-2">
            ...
            <li class="nav-item bg-info"><a href="#" class="nav-link text-light"><h4>Your Profile</h4></a></li>
            <?php
            ...
            <li class="nav-item "><a href="profile.php?edit_account" class="nav-link text-light">Edit account</a></li>
            <li class="nav-item "><a href="profile.php?my_orders" class="nav-link text-light">My Orders</a></li>
            <li class="nav-item "><a href="profile.php?delete_account" class="nav-link text-light">Delete Account</a></li>
